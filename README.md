...
Our main analyses can be reproduced using the file `model.R` (the working directory in R should be set to `Parental_Age_Scripts/`). Figures will be written to the folder `img/`.
